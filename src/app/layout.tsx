...
export const metadata: Metadata = {
  title: "Basketball Championship 2024 - Six Teams Compete",
  description: "Experience the ultimate basketball tournament as six elite teams compete for the championship title. Live games, highlights, and exclusive content.",
  keywords: "basketball tournament, championship, sports competition, basketball teams, live games",
  metadataBase: new URL("https://basketballchampionship2024.com"),
  alternates: {
    canonical: "https://basketballchampionship2024.com"
  },
  openGraph: {
    title: "Basketball Championship 2024 - Six Teams Compete",
    description: "Experience the ultimate basketball tournament as six elite teams compete for the championship title.",
    url: "https://basketballchampionship2024.com",
    siteName: "Basketball Championship",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34kFQ1mvageIxtFsoHwjFOCooyh/uploaded-1763639689132-s93wq7f6.jpg",
      alt: "Basketball Championship 2024 tournament"
    }],
    type: "website"
  },
  twitter: {
    ...
    title: "Basketball Championship 2024 - Six Teams Compete",
    description: "Experience the ultimate basketball tournament as six elite teams compete for the championship title.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34kFQ1mvageIxtFsoHwjFOCooyh/uploaded-1763639689132-s93wq7f6.jpg"]
  },
  robots: {
    index: true,
    follow: true
